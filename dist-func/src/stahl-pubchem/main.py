...
x = numpy.vstack((tmp5[11:28, :], tmp5[140:183, :], tmp5[195:226, :], tmp5[238:243, :], tmp5[255:267, :],
                   tmp5[279:334, :]))
y = numpy.vstack((tmp5[1:10, :], tmp5[129:139, :], tmp5[184:194, :], tmp5[227:237, :], tmp5[244:254, :],
                   tmp5[268:278, :]))
# # Dataset
# x = numpy.matrix(
