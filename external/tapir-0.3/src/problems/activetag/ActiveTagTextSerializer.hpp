/** @file ActiveTagTextSerializer.hpp
 *
 * Contains text-based serialization methods for the core classes implementing ActiveTag, that is:
 * ActiveTagChange, ActiveTagState, ActiveTagAction, and ActiveTagObservation.
 */
#ifndef ACTIVETAGTEXTSERIALIZER_HPP_
#define ACTIVETAGTEXTSERIALIZER_HPP_
...
/** A serialization class for the ActiveTag problem.
 *
 * This contains serialization methods for ActiveTagChange, ActiveTagState, ActiveTagAction, and ActiveTagObservation;
 ...
 */
class ActiveTagTextSerializer: virtual public solver::TextSerializer,
        virtual public solver::EnumeratedActionTextSerializer,
        virtual public solver::DiscreteObservationTextSerializer {
  public:
    /** Creates a new ActiveTagTextSerializer instance, associated with the given solver. */
    ActiveTagTextSerializer(solver::Solver *solver);

    virtual ~ActiveTagTextSerializer() = default;
    _NO_COPY_OR_MOVE(ActiveTagTextSerializer);
...
#endif /* ACTIVETAGTEXTSERIALIZER_HPP_ */
